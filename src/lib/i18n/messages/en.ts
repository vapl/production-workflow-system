const en = {
  ...
  companyPage: {
    ...
    plan: "Plan",
    basic: "Basic",
    basicDescription: "Manual external orders only",
    pro: "Pro",
  ...
  orders: {
    ...
    detail: {
      ...
      external: {
        ...
        selectValue: "Select value",
        noFieldsTitle: "No external order fields configured",
        noFieldsDescription1:
          "External Orders is used to track outsourced work with partners: order details, deadlines, pricing, and delivery notes.",
        noFieldsDescription2:
          "Configure fields in Settings -> Partners -> External order schema, then return here.",
        ...
        addExternalJob: "Add external order",
        edit: "Edit",
        save: "Save",
        cancel: "Cancel",
        empty: "No external orders added yet.",
      ...
      importModal: {
        ...
        mismatchProducts: "{count} rows look like components, not unit rows.",
        mismatchComponents: "{count} rows look like units, not component rows.",
        ...
        automaticDetectionNotice: "Automatic detection was used for this file.",
        ...
        errors: {
          ...
          noValidComponentRows:
            "No valid named rows found for component import.",
      ...
      errors: {
        ...
        missingPrimaryUnitTable:
          "Define a primary units table in settings first.",
        pdfUseAiImport:
      ...
      confirm: {
        ...
        deleteExternalJob: "Delete external order?",
        thisWillRemoveExternalJob:
          "This will remove the external order from the order.",
      },
      notifications: {
    ...
    externalReceivePage: {
      ...
      enableAiFields:
        "Enable AI extract fields in Settings -> External order schema.",
    ...
    context: {
      ...
      errors: {
        ...
        removeOwnCommentsOnly: "You can only remove your own comments.",
        failedToAddExternalJob: "Failed to add external order.",
        failedToUpdateExternalJob: "Failed to update external order.",
  ...
  production: {
    main: {
      ...
      inProgress: {
        headerSubtitle:
          "Active production work with statuses, stations, and due-date risks.",
        mobileSubtitle: "See what is currently running in production.",
        activeOrders: "Active orders",
        activeOrdersHint: "Orders currently in production.",
        activeRuns: "Active runs",
        activeRunsHint: "Runs not yet completed and still being processed.",
        blockedRuns: "Blocked runs",
        blockedRunsHint: "Runs needing attention due to blocking issues.",
        dueNow: "Due now",
        dueNowHint: "Active orders due today or already late.",
        listTitle: "In production",
        listSubtitle:
          "Primary live list for TV screens, managers, and the shop floor.",
        searchPlaceholder: "Order, customer, station...",
        dateHint: "Choose a day or click a week number to select the whole week.",
        noOrders: "No active orders in production.",
        statusTitle: "Status",
        quickFilters: "Quick filters",
        overdueOnly: "Overdue only",
        blockedOnly: "Blocked only",
        ...
        startedAt: "Started",
        duration: "In work",
        openQueues: "Open station queues",
        openStaff: "Open staff",
        openOrder: "Open order",
        viewJob: "Open work order",
        statuses: {
          pending: "Queued",
          in_progress: "In progress",
          paused: "Paused",
      ...
      split: {
        ...
        stations: "Stations",
        selectedRowsQueued:
          "Selected rows will be queued on the chosen stations.",
      ...
      settingsModal: {
        ...
        description:
          "Configure working hours, the station catalog, and production workflow rules.",
        operations: "Operations and stations",
        workflow: "Workflow and statuses",
        stationCatalogDescription:
          "Opens the main station catalog used across production routes and queues.",
        openStationCatalog: "Open station catalog",
        hint:
          "These settings apply across production views and the staff PIN experience.",
      },
      queues: {
        ...
        overtime: "OT",
        involvedOperators: "Involved operators: {count}",
        workingOperators: "Working: {names}",
        pausedOperators: "Paused: {names}",
        blockedOperators: "Blocked: {names}",
      ...
      jobs: {
        ...
        failedReleaseToQueues: "Failed to release the job to station queues.",
        failedUpdateOverview: "Failed to update overview fields.",
        reopenCompletedAction: "Reopen for correction",
        reopenedForCorrection: "Completed work was reopened for correction.",
        ...
        notReleasedYet:
          "This unit has not yet been released to station queues.",
        actions: "Actions",
        splitRelease: "Split / release",
        replanQueuedRows: "Replan queued rows",
        actionsIdle:
          "This job is already planned or there are no stations to assign.",
        actionsRelease:
          "Release constructions from the job and split them across stations.",
      ...
      operators: {
        ...
        backToReady: "Back to Ready for production",
        title: "Staff",
        subtitle: "Productivity, time, and completed units by staff member.",
        mobileSubtitle: "View for productivity, time, and labor cost.",
        manageTitle: "Manage staff",
        manageList: "Staff",
        manageListHint:
          "Manage access and PIN sign-in for operators and warehouse staff.",
        manageNew: "New staff member",
        manageNewProfile: "New staff profile",
        manageActive: "Active",
        manageInactive: "Inactive",
        manageEmpty: "No staff yet.",
        ...
        manageBasicInfoHint:
          "Staff member name and access code for the PIN login screen.",
        manageRole: "Role",
        manageRoleHint:
          "Choose whether this PIN user works as an operator or warehouse.",
        manageRoleOperator: "Operator",
        manageRoleWarehouse: "Warehouse",
        manageAccess: "Access",
        manageAccessHint: "4-digit PIN for staff sign-in.",
        managePin: "PIN code",
        managePinHint:
          "Staff members use a 4-digit PIN. Leave empty on edit to keep the current PIN.",
        ...
        completedQty: "Completed units",
        completedQtyHint: "Completed units in the selected period.",
        relatedUnits: "Linked units",
        relatedUnitsHint:
          "Units linked to operator work on order-level stations in the selected period.",
        ordersHint: "Orders where operators had work in the selected period.",
        laborCost: "Labor cost",
        laborCostHint: "Based on saved hourly rates.",
        listTitle: "Operators list",
        listSubtitle:
          "A view for productivity and cost, not the daily execution queue.",
        searchPlaceholder: "Name, role, station...",
        filterByStation: "Filter by station",
        sortBy: "Sort by",
        allStations: "All stations",
        sortWorkedHours: "Worked hours",
        sortLaborCost: "Labor cost",
        sortUnits: "Units",
        sortOrders: "Orders",
        sortName: "Name",
        loading: "Loading...",
      ...
      operatorDetail: {
        ...
        mobileSubtitle: "Operator work overview with KPIs and activity.",
        profile: "Profile",
        name: "Name",
        role: "Role",
        stations: "Stations",
        workOverview: "Work overview",
        currentWork: "Active work",
        activeNow: "Working now",
        notActiveNow: "No active work",
        statusLabel: "Status",
        statuses: {
          queued: "Queued",
          pending: "Pending",
        ...
        activeSince: "Started",
        elapsed: "Elapsed",
        dataQuality: "Data source",
        preciseSessions: "Precise work sessions",
        estimatedFromStatuses: "Estimated from statuses",
        efficiencyQtyPerHour: "Items/h",
        efficiencyMinutesPerUnit: "Min/item",
        avgOrderTime: "Avg. per order",
        shareOfTime: "Time share",
        shareOfTimeHint:
          "How much of the operator's total worked time in this period was spent at this station.",
        ...
        batch: "Batch",
        pauses: "Pauses",
        pauseReasonFilter: "Filter by reason",
        reason: "Reason",
        pauseDuration: "Pause duration",
        workedBeforePause: "Worked before pause",
        allReasons: "All reasons",
        noPausesForFilters: "No pauses found in this period.",
        noPausesForReason: "No pauses found for this reason.",
        showMorePauses: "Show {count} more",
        showLessPauses: "Show only 10",
        payRates: "Pay rates",
        settingsTitle: "Operator settings",
        settingsRatesHint:
          "Rates are used for labor cost calculation in this operator report.",
        workNorms: "Work norms",
        workNormsHint:
          "Norms can later be used to compare planned and actual workload.",
        workNormsSummaryHint:
          "No work norms are set for this operator yet, so plan-vs-actual comparison is unavailable.",
        configureWorkNorms: "Set norms",
        periodTarget: "Period target",
        actualWorked: "Actual",
        workNormDeviation: "Deviation",
        overNorm: "Over target",
        periodOvertimeThreshold: "Overtime threshold",
        workNormsCardHint:
          "Calculated for the selected period and {days} working days.",
        weeklyTargetHours: "Weekly target (h)",
        monthlyTargetHours: "Monthly target (h)",
        overtimeThresholdHours: "Overtime threshold (h)",
        absences: "Absences",
        absencesHint:
          "Vacations and other absences for operator planning and monthly reports.",
        addAbsence: "Add absence",
        noAbsences: "No absences added.",
        absenceType: "Type",
        absenceStart: "From",
        absenceEnd: "To",
        absenceNote: "Comment",
        absenceNotePlaceholder: "Note...",
        ...
        settingsManagedElsewhere:
          "PIN, access, deactivation, and station assignments stay in the main Manage operators modal.",
        openOperatorManagement: "Open operator management",
        settingsInvalidAbsence:
          "Check absence dates: the end date must be after the start date.",
        settingsSaved: "Operator settings saved.",
        ...
        filters: "Work overview filters",
        month: "Month",
        period: "Period",
        periodPickerHint:
          "Select a start date, then an end date. Close with OK.",
        orderLevelTrackingHint:
          "Work is tracked at order level. Units below are shown as linked to orders.",
        ...
        completedOrderTime: "Completed order time",
        otherWorkedTime: "Other active/unfinished work",
        byUnits: "By units",
        statusFilter: "Filter by status",
        allStatuses: "All statuses",
        relatedUnitsShort: "Linked units",
        ...
        noUnitsForFilters:
          "No construction-level work sessions in this period. Time may be tracked at order or station level.",
        done: "Done",
      },
      list: {
    ...
    operator: {
      ...
      queue: {
        ...
        activeOperators: "Involved operators: {count}",
        activeOperatorList: "Working: {names}",
        workingOperators: "Working: {names}",
        pausedOperators: "Paused: {names}",
        blockedOperators: "Blocked: {names}",
        myStatus: "My status: {status}",
        myTime: "My time: {value}",
        availableOn: "Available on {date}",
        outsideWorkingHours:
          "Work can only be started or resumed during configured working hours.",
        receiptAction: "Receipt action for this batch",
        batchActions: "Batch actions for this station",
        constructionActions: "Actions for this construction",
      },
      actions: {
        start: "Start",
        resume: "Resume",
      ...
      doneConfirm: {
        ...
        itemDescription: 'Are you sure you want to mark "{label}" as done?',
        unitsDescription:
  ...
  settings: {
    ...
    workflow: {
      ...
      externalJobStatusConfiguration: "External order status configuration",
    ...
    partners: {
      ...
      externalSchemaTitle: "External order schema",
      externalSchemaDescription:
        "Configure the fields captured for outsourced orders.",
      noExternalFields:
        "No external order fields yet. Add your first field to start.",
      externalFieldsHint:
        "Add or edit the fields shown on external order forms.",
