const lv = {
  ...
  production: {
    main: {
      ...
      inProgress: {
        headerSubtitle:
          "Aktīvie ražošanas darbi ar statusiem, stacijām un termiņu riskiem.",
        mobileSubtitle: "Skati, kas šobrīd notiek ražošanā.",
        activeOrders: "Aktīvie pasūtījumi",
        activeOrdersHint: "Pasūtījumi, kas šobrīd ir ražošanā.",
        activeRuns: "Aktīvās rindas",
        activeRunsHint: "Rindas, kas nav pabeigtas un vēl tiek apstrādātas.",
        blockedRuns: "Bloķētās rindas",
        blockedRunsHint: "Rindas ar bloķējumu, kam vajag uzmanību.",
        dueNow: "Termiņš tagad",
        dueNowHint: "Aktīvie pasūtījumi ar termiņu šodien vai kavētu.",
        listTitle: "Ražošanā",
        listSubtitle:
          "Galvenais operatīvais saraksts TV ekrāniem, vadītājiem un ceham.",
        searchPlaceholder: "Pasūtījums, klients, stacija...",
        dateHint: "Izvēlies dienu vai spied uz nedēļas numura, lai atlasītu visu nedēļu.",
        noOrders: "Nav aktīvu pasūtījumu ražošanā.",
        statusTitle: "Statuss",
        quickFilters: "Ātrie filtri",
        overdueOnly: "Tikai nokavētie",
        blockedOnly: "Tikai bloķētie",
        ...
        startedAt: "Palaists",
        duration: "Procesā",
        openQueues: "Atvērt staciju rindas",
        openStaff: "Atvērt personālu",
        openOrder: "Atvērt pasūtījumu",
        viewJob: "Atvērt darba uzdevumu",
        statuses: {
          pending: "Rindā",
          in_progress: "Procesā",
          paused: "Pauzē",
      ...
      settingsModal: {
        title: "Ražošanas iestatījumi",
        description:
          "Pielāgojiet darba laikus, staciju katalogu un ražošanas plūsmas noteikumus.",
        operations: "Operācijas un stacijas",
        workflow: "Plūsma un statusi",
        stationCatalogDescription:
          "Atver galveno staciju katalogu, kas tiek izmantots visos ražošanas maršrutos un rindās.",
        openStationCatalog: "Atvērt staciju katalogu",
        hint:
          "Šie iestatījumi attiecas uz visiem ražošanas skatiem un personāla PIN pieeju.",
      },
      queues: {
        ...
        overtime: "Virsst.",
        involvedOperators: "Iesaistīti operatori: {count}",
        workingOperators: "Strādā: {names}",
        pausedOperators: "Pauzē: {names}",
        blockedOperators: "Bloķēts: {names}",
      ...
      operators: {
        ...
        title: "Personāls",
        subtitle:
          "Produktivitāte, laiks un izpildītās vienības pa darbiniekiem.",
        mobileSubtitle: "Skats produktivitātei, laikam un izmaksām.",
        manageTitle: "Pārvaldīt personālu",
        manageList: "Personāls",
        manageListHint:
          "Pārvaldiet operatoru un noliktavas darbinieku piekļuvi un PIN pieteikšanos.",
        manageNew: "Jauns darbinieks",
        manageNewProfile: "Jauns darbinieka profils",
        manageActive: "Aktīvs",
        manageInactive: "Neaktīvs",
        manageEmpty: "Personāla vēl nav.",
        ...
        manageBasicInfoHint:
          "Darbinieka vārds un piekļuves kods PIN pieteikšanās ekrānam.",
        manageRole: "Loma",
        manageRoleHint:
          "Izvēlieties, vai PIN lietotājs strādās kā operators vai noliktava.",
        manageRoleOperator: "Operators",
        manageRoleWarehouse: "Noliktava",
        manageAccess: "Piekļuve",
        manageAccessHint: "4 ciparu PIN darbinieka pieteikšanai.",
        managePin: "PIN kods",
        managePinHint:
          "Darbiniekiem izmantojam 4 ciparu PIN. Rediģējot atstājiet tukšu, ja PIN nemainās.",
        ...
        completedQty: "Pabeigtas vienības",
        completedQtyHint: "Pabeigtās vienības izvēlētajā periodā.",
        ...
        filterByStation: "Filtrēt pēc stacijas",
        sortBy: "Kārtot pēc",
        allStations: "Visas stacijas",
        sortWorkedHours: "Pēc nostrādātajām stundām",
        sortLaborCost: "Pēc darba izmaksām",
        sortUnits: "Pēc vienībām",
        sortOrders: "Pēc pasūtījumiem",
        sortName: "Pēc vārda",
        loading: "Ielādē...",
        itemsShort: "Vien.",
      ...
      operatorDetail: {
        ...
        mobileSubtitle: "Operatora darba pārskats ar KPI un aktivitāti.",
        profile: "Profils",
        name: "Vārds",
        role: "Loma",
        stations: "Stacijas",
        workOverview: "Darba pārskats",
        currentWork: "Aktīvais darbs",
        activeNow: "Strādā tagad",
        notActiveNow: "Nav aktīva darba",
        statusLabel: "Statuss",
        statuses: {
          queued: "Rindā",
          pending: "Gaida",
        ...
        activeSince: "Sākts",
        elapsed: "Ilgums",
        dataQuality: "Datu avots",
        preciseSessions: "Precīzas darba sesijas",
        estimatedFromStatuses: "Aprēķins no statusiem",
        efficiencyQtyPerHour: "Vien./h",
        efficiencyMinutesPerUnit: "Min./vien.",
        avgOrderTime: "Vid. pasūtījumam",
        shareOfTime: "Laika īpatsvars",
        shareOfTimeHint:
          "Cik liela daļa no operatora kopējā nostrādātā laika šajā periodā bija šajā stacijā.",
        completedUnits: "Pabeigtas vienības",
        units: "Vienības",
        order: "Pasūtījums",
        customer: "Klients",
        time: "Laiks",
        ...
        batch: "Partija",
        pauses: "Pauzes",
        pauseReasonFilter: "Filtrēt pēc iemesla",
        reason: "Iemesls",
        pauseDuration: "Pauzes ilgums",
        workedBeforePause: "Nostrādāts pirms pauzes",
        allReasons: "Visi iemesli",
        noPausesForFilters: "Šajā periodā pauzes nav atrastas.",
        noPausesForReason: "Šim iemeslam pauzes nav atrastas.",
        showMorePauses: "Rādīt vēl {count}",
        showLessPauses: "Rādīt tikai 10",
        payRates: "Darba likmes",
        settingsTitle: "Operatora iestatījumi",
        settingsRatesHint:
          "Likmes izmanto darba izmaksu aprēķinam šajā operatora pārskatā.",
        workNorms: "Darba norma",
        workNormsHint:
          "Normas var izmantot, lai vēlāk salīdzinātu plānoto un faktisko noslodzi.",
        workNormsSummaryHint:
          "Šim operatoram normas vēl nav iestatītas, tāpēc plāna un fakta salīdzinājums nav pieejams.",
        configureWorkNorms: "Iestatīt normas",
        periodTarget: "Norma periodam",
        actualWorked: "Fakts",
        workNormDeviation: "Novirze",
        overNorm: "Virs normas",
        periodOvertimeThreshold: "Virsstundu slieksnis",
        workNormsCardHint:
          "Aprēķins veikts izvēlētajam periodam un {days} darba dienām.",
        weeklyTargetHours: "Nedēļas norma (h)",
        monthlyTargetHours: "Mēneša norma (h)",
        overtimeThresholdHours: "Virsstundu slieksnis (h)",
        absences: "Prombūtnes",
        absencesHint:
          "Atvaļinājumi un citas prombūtnes operatora plānošanai un mēneša pārskatam.",
        addAbsence: "Pievienot prombūtni",
        noAbsences: "Prombūtnes nav pievienotas.",
        absenceType: "Tips",
        absenceStart: "No",
        absenceEnd: "Līdz",
        absenceNote: "Komentārs",
        absenceNotePlaceholder: "Piezīme...",
        removeAbsence: "Noņemt prombūtni",
        absence: {
          vacation: "Atvaļinājums",
          sickLeave: "Slimības lapa",
          unpaid: "Neapmaksāta prombūtne",
          training: "Mācības",
        },
        settingsManagedElsewhere:
          "PIN, piekļuve, deaktivizēšana un staciju piesaiste paliek galvenajā Operatoru pārvaldības modālī.",
        openOperatorManagement: "Atvērt operatoru pārvaldību",
        settingsInvalidAbsence:
          "Pārbaudi prombūtnes datumus: beigu datumam jābūt pēc sākuma datuma.",
        settingsSaved: "Operatora iestatījumi saglabāti.",
        ...
        filters: "Darba pārskata filtri",
        month: "Mēnesis",
        period: "Periods",
        periodPickerHint:
          "Izvēlies sākuma datumu un pēc tam beigu datumu. Aizver ar OK.",
        orderLevelTrackingHint:
          "Darbs tiek uzskaitīts pasūtījuma līmenī. Zemāk vienības ir parādītas kā ar pasūtījumiem saistītas.",
        ...
        orders: "Pasūtījumi",
        completedOrders: "Pabeigtie pasūtījumi",
        orderTime: "Pasūtījumu laiks",
        completedOrderTime: "Pabeigto pasūtījumu laiks",
        otherWorkedTime: "Cits aktīvs/nepabeigts darbs",
        byUnits: "Pa vienībām",
        statusFilter: "Filtrēt pēc statusa",
        allStatuses: "Visi statusi",
        relatedUnitsShort: "Saist. vien.",
        ...
        noUnitsForFilters:
          "Nav konstrukciju līmeņa darba sesiju šajā periodā. Laiks var būt piesaistīts pasūtījumam vai stacijai.",
        done: "Pabeigts",
      },
      list: {
    ...
    operator: {
      ...
      queue: {
        ...
        activeOperators: "Iesaistīti operatori: {count}",
        activeOperatorList: "Strādā: {names}",
        workingOperators: "Strādā: {names}",
        pausedOperators: "Pauzē: {names}",
        blockedOperators: "Bloķēts: {names}",
        myStatus: "Mans statuss: {status}",
        myTime: "Mans laiks: {value}",
        availableOn: "Pieejams no {date}",
        outsideWorkingHours:
          "Darbu var sākt vai atsākt tikai iestatītajā darba laikā.",
        receiptAction: "Saņemšanas darbība šai partijai",
        batchActions: "Partijas darbības šai stacijai",
        constructionActions: "Darbības šai konstrukcijai",
      },
      actions: {
        start: "Sākt",
        resume: "Atsākt",
