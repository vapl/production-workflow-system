...
const SelectTrigger = ({
  ...
  <SelectPrimitive.Trigger
    className={cn(
      "ui-control relative flex w-full min-w-0 items-center justify-between gap-2 overflow-hidden rounded-lg border border-border bg-input-background px-3 pr-9 text-sm text-foreground",
  ...
  >
    {children}
    <SelectPrimitive.Icon className="absolute right-3 inline-flex h-4 w-4 items-center justify-center text-muted-foreground">
