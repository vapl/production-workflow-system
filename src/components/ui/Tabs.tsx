...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "flex h-9 w-fit items-center justify-center rounded-full border border-(--tabs-border) bg-(--tabs-bg) p-1 text-(--tabs-text) shadow-sm",
        className,
      )}
      {...props}
    />
